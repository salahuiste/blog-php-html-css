...
if($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$rep=$bdd->query('SELECT username,pasword FROM tbl_user');
		while($donnes=$rep->fetch()) {
			$pass_hashed=md5($_POST['password']);
			if($_POST['username']==$donnes['username'] && $pass_hashed==$donnes['pasword'] )
			{
...
<div id="log"> 
	<p style="font-size: 1.5em; font-weight: bold; color: #0782c8; ">Login to Blog Admin System</p>

...
if(empty($_SESSION['allowed']) OR $_SESSION['allowed']=='non' ) {
	...
	if($_SERVER["REQUEST_METHOD"] == "POST") {
		...
		$pat=NULL;
		$pre=$bdd->prepare('INSERT INTO tbl_articles (title,description,date_article,image) VALUES(:title,:descr,:datee,:image)');
		...
		$msg="<span style='color:green;'>Done</span>";
...
<?php include 'includes/header.php'; ?>
	...
	<table align="center">
		...
		<tr>
			...
			<td>
				<textarea class="pn" cols="100" rows="16" name='descr'></textarea>
			</td>
		</tr>
		<tr>
